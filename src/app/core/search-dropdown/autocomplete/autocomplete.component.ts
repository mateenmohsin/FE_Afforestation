...
export class AutocompleteComponent implements OnInit, OnChanges, AfterViewInit, ControlValueAccessor
{
	...
	@ViewChild('filteredListElement', { static: true }) filteredListElement: ElementRef; // element of items
	@ViewChild('historyListElement', { static: true }) historyListElement: ElementRef; // element of history items
